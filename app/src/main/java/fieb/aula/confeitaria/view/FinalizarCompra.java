...
//        int idUltimoIdGerado = itensDoPedidoController.consultarIdPedido(getApplicationContext()).getID_CURSO();
//
...
//
//            tvFecharNomeBolo.setText(objLinha.getCURSO());
//            tvFecharPreco.setText(Auxiliares.formatarNumero(objLinha.getCARGA_HORARIA()));
