...
//        aBtnFecharPedido = btnFecharPedido;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        tvIdBolo.setText(String.valueOf(objLinha.getID_CURSO()));
